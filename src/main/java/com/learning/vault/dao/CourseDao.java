		...
		try{
			...
			if(session!=null) {
	            ...
	            if(course!=null) {
	            	...
	            	List<Subject> courseSubjects = course.getSubjects()==null ? new ArrayList<Subject>() : course.getSubjects();
	            	
	            	if(subject!=null) {	            		
	            		boolean found = courseSubjects.stream().anyMatch(s -> s.getSubjectId()==subject.getSubjectId());
